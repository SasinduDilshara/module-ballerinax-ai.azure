...
// ===== Azure Anthropic (Claude) triggers =====
// The `_NO_DETAILS` variant MUST be listed before its base marker in the mock's dispatch, since the base marker
// is a prefix of the variant.
const TRIGGER_ANTHROPIC_REFUSAL = "TRIGGER_ANTHROPIC_REFUSAL";
const TRIGGER_ANTHROPIC_REFUSAL_NO_DETAILS = "TRIGGER_ANTHROPIC_REFUSAL_NO_DETAILS";
const TRIGGER_ANTHROPIC_CONTEXT_EXCEEDED = "TRIGGER_ANTHROPIC_CONTEXT_EXCEEDED";
const TRIGGER_ANTHROPIC_EMPTY_CONTENT = "TRIGGER_ANTHROPIC_EMPTY_CONTENT";
const TRIGGER_ANTHROPIC_BLANK_TEXT = "TRIGGER_ANTHROPIC_BLANK_TEXT";
const TRIGGER_ANTHROPIC_THINKING_BLOCKS = "TRIGGER_ANTHROPIC_THINKING_BLOCKS";
const TRIGGER_ANTHROPIC_TEXT_AND_TOOL = "TRIGGER_ANTHROPIC_TEXT_AND_TOOL";
const TRIGGER_ANTHROPIC_TOOL_NO_NAME = "TRIGGER_ANTHROPIC_TOOL_NO_NAME";
const TRIGGER_ANTHROPIC_TOOL_BAD_INPUT = "TRIGGER_ANTHROPIC_TOOL_BAD_INPUT";
const TRIGGER_ANTHROPIC_ERROR_ENVELOPE = "TRIGGER_ANTHROPIC_ERROR_ENVELOPE";
const TRIGGER_ANTHROPIC_ERROR_PLAIN = "TRIGGER_ANTHROPIC_ERROR_PLAIN";
const TRIGGER_ANTHROPIC_MALFORMED_BODY = "TRIGGER_ANTHROPIC_MALFORMED_BODY";
// The model answers the forced `getResults` tool call with plain text instead of calling the tool.
const TRIGGER_ANTHROPIC_NO_TOOL_USE = "TRIGGER_ANTHROPIC_NO_TOOL_USE";
// A truncated response (`stop_reason: "max_tokens"`) and a paused turn.
const TRIGGER_ANTHROPIC_TRUNCATED = "TRIGGER_ANTHROPIC_TRUNCATED";
const TRIGGER_ANTHROPIC_PAUSE_TURN = "TRIGGER_ANTHROPIC_PAUSE_TURN";
