...
final azure:OpenAiModelProvider openAiProvider = check new (SERVICE_URL, API_KEY, DEPLOYMENT_ID, API_VERSION);

@test:Config
function testGenerateMethodWithBasicReturnType() returns error? {
...
@test:Config
function testGenerateMethodWithBasicArrayReturnType() returns error? {
...
@test:Config
function testGenerateMethodWithInvalidRecordType() returns error? {
...
@test:Config
function testGenerateMethodWithInvalidRecordArrayType2() returns error? {
